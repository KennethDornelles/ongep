...
export default function Home() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            {/* Hero Section - Área verde escura com o título ONGEP e subtítulo */}            <section className="relative w-full h-[500px] bg-[#e90c26] flex items-center justify-center text-white overflow-hidden">                {/* Logo como marca d'água */}                <div className="absolute inset-0 flex items-center justify-center overflow-hidden">                    <img src="/ongep_logo.png"
                ...
                alt=""
            />
            </div><div className="container mx-auto px-4 z-20 text-center relative">                    <img src="/ongep_logo.png"
